...
interface Props {
  digest?: DigestCycle;
  submitText?: string;
  onCreate: (digest: DigestCycle) => void;
}

const emptyDigest: DigestCycle = {
  content: '',
...
export const CreateEditDigest = memo(
  ({ digest = emptyDigest, onCreate, submitText }: Props) => {
    ...
    const createDisabled = useMemo(
      () =>
        !Boolean(editDigest.title) ||
        !Boolean(editDigest.description) ||
        !Boolean(editDigest.content) ||
        !Boolean(editDigest.date),
      [editDigest],
    );

    const previewDisabled = useMemo(() => !Boolean(editDigest.content), [
      editDigest,
    ]);
