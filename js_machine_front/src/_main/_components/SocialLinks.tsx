...
import VkIcon from '../_images/vk-icon.png';
import TelegramIcon from '../_images/telegram-icon.png';
import InstaIcon from '../_images/instagram-icon.png';
import '../_styles/socialLinks.css';
